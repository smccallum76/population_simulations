...
for batch in idx_batch_list:
    ...
    stat_tbl_batch = pd.DataFrame() # df to hold all the stats from a batch set
    for sim in sims:
        crnt = df1[df1['vcf_name'] == sim]
        ...
        stat_tbl['simulation_type'] = 'neutral_type'
