...
neutral = sa.read_vcf("../simulations/output/ts_neutral_Scaling9_300x40_05.vcf")
sweep = sa.read_vcf("../simulations/output/ts_sweep_Scaling9_300x40_05.vcf")
...
ax[0].axvline(x=2.5e6, color='black', linestyle='--', label='Sweep Location')
ax[0].set_xlabel("SNP Number")
ax[0].set_title("Sweep Sims -- Allele Frequency by SNP")
ax[0].legend(loc="upper left")
ax[1].set_xlabel("SNP Number")
ax[1].axvline(x=2.5e6, color='black', linestyle='--', label='Sweep Location')
